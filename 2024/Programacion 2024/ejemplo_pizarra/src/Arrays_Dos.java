...
public class Arrays_Dos {
    public static void main(String[] args) throws Exception{
        ...
        for(int i= 0; i<numeros.length; i++){
             ...
             * numeros es el nombre del array con lo cual en cada vuelta se guarda lo que introduce el usuario
            */
            numeros[i]=num;
        }
        for(int i = 0; i<numeros.length; i++){
            ...
            System.out.println("Los valores introducidos dinamicamente son "+numeros[i]);
        }
    }
}
