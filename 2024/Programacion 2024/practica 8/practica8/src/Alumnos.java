...
public Alumnos (String id, String nombre1, String nombre2, String apellido1, String apellido2,String email, String telefono){
    this.id= id;
...
public String toString() {
    return "Alumnos [id=" + id + ", nombre1=" + nombre1 + ", nombre2=" + nombre2 + ", apellido1=" + apellido1
