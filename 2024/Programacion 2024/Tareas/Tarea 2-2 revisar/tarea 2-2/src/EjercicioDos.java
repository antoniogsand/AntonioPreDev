...
public class EjercicioDos {
    public static void main(String[] args) throws Exception{
        ...
        int anyo = sc.nextInt();
//jhihhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiii++++++++--
        String fecha = dia +2 + "/" + mes + "/" + anyo;

        if (dia == 28 && mes == 4 || mes == 6 || mes == 9 || mes == 11){
            dia = 30;
